...
```text
โจทย์ให้จับคู่ key ในตารางแล้วดึง ราค่าส่งมา + กับ ราคาน้ำหนัก หากไม่มีให้ขึ้น error
Input:
จุดเริ่มต้นและจุดจบและค่าน้ำหนัก
Output:
พิมพ์ราคาที่ต้องจ่าย
Constraints:
จุดเริ่มต้นและจุดจบเป็นตัวพิมพ์ใหญ่ ส่วนค่าน้ำหนักเป็น float
```
...
```text
Step 1: รับค่า จุดเริ่มและปลายทางและน้ำหนัก
Step 2: ดึงค่าจาก ตารางตาม จุดเริ่มและปลายทาง
Step 3: หากมีค่าให้คำนวณค่าที่ต้องจ่าย หากไม่มีให้พิมพ์ Error
Step 4: พิมพ์ค่าที่ต้องจ่าย
```
...
```text
ใช้แผลเดิม เพราะ ดูแล้วเข้าใจและอ่านง่าย
```
