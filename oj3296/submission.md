...
```text
Input:
รับค่าจำนวนเต็มบวก 3 ตัว 2 บรรทัด

Output:
ควรพิมพ์ ค่าสีที่เฉลี่ยมาจาก 2 สี

Constraints:
input มีหลายตัวในบรรทัดเดียวต้องใช้ split()
```
...
```text
Step 1 : อ่านค่าสีทั้ง 2 บรรทัด
Step 2 : เอาค่าสีแต่ละสี มาบวกกันแล้ว หารไม่เอาเศษด้วย 2
Step 3 : พิมพ์ค่าสีที่บวกและหารแล้ว
```
