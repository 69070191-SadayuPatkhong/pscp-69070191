...
```text
Input:
1: ค่าอุณหภูมิ เป็นจำนวนจริง
2: หน่วยต้นทาง C, F, K, R
3: หน่วยปลายทาง C, F, K, R
Output: อุณหภูมิในหน่วยปลายทางและมีทศนิยม 2 ตำแหน่ง
Constraints: หน่วยอุณหภูมิ C, F, K, R
ค่าอุณหภูมิในหน่วย K และ แรงคิน R ต้องไม่ต่ำกว่า 0
```
...
```text
Step 1: อ่านค่าอุณหภูมิ หน่วยต้นทาง และหน่วยปลายทาง
Step 2: แปลงอุณหภูมิจากหน่วยต้นทางให้เป็นหน่วยเซลเซียส
Step 3: คำนวณเปลี่ยนค่าเซลเซียสไปเป็นหน่วยปลายทาง
Step 4: พิมพ์ผลลัพธ์แบบทศนิยม 2 ตำแหน่ง
```
...
```text
ใช้เหมือนเดิมเพราะ เป็นโจทย์ตรงไปตรงมาให้เปลี่ยน ค่าไปอีกค่าหนึงจาม โจทย์
```
...
```text
เป็นจุดเยือกแข็งของน้ำทดสอบการแปลงข้ามจาก F ไป K
```
