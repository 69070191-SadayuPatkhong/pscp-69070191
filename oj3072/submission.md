...
input : string 1 อัน
output : จำนวนสระ แต่ละตัว หากไม่มีตัวนั้นไม่ต้องขึ้น
constraints : string เป็นตัวพิมพ์ใหญ่หรือเล็กก็ได้
```
...
```text
Step 1: อ่าน string แล้วแปลงเป็น ตัวเล็ก
Step 2: loop นับ text แต่ละตัวว่าเป็น aeiou รึป่าวแล้วเพิ่มค่าแต่ละตัว
Step 3: พิมพ์จำนวนแต่ละตัว
```
...
```text
ตัวเลขและตัวพิมพ์ใหญ่เล็กและ การเรียง
```
