...
```text
input:
รับ text แล้วดึกตัวสุดท้ายแล้ว หัวหน้าที่เหลื่อ
 
output:
ควรออกเป็นคำที่ แปลงออกมาแล้วเช่น QS เป็น queen of spades

constraints:
input เป็น text ติกกันควรใช้ strip
```
...
```text
Step 1: รับค่า text
Step 2: เอาตัวท้ายของ text และตัวที่เหลื่อเป็น ตัวแปร
Step 3: หากเป็นตัวเลขให้ใช้ตัวเลขไปเลย หากไม่ใช้เอาเช็กกับ dictionary แล้วเอา value
Step 4: พิมพ์ค่าที่ได้จาก ตาราง dictionary
```
