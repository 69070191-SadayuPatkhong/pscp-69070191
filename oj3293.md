...
```text
โจทย์ให้เอา Input ไปใส่กรอบ
Input:
โปรแกรมรับ String 5 บรรทัด

Output:
โปรแกรมควรพิมพ์ Input ที่ใส่กรอบแล้ว

Constraints:
Input เป็น string แต่มี 5 บรรทัด ต้องรับ input หลายรอบ
```
...
```text
Step 1: อ่านข้อความ 5 บรรทัด เก็บไว้ใน list
Step 2: ตัด whitespace ท้ายบรรทัดออกจากแต่ละบรรทัด
Step 3: หาความยาวมากที่สุดในบรรดา 5 บรรทัด
Step 4: สร้างเส้นขอบตามความยาวที่มากที่สุด 
Step 5: พิมพ์เส้นขอบบน
Step 6: วนพิมพ์แต่ละบรรทัด
Step 7: พิมพ์เส้นขอบล่าง
```
