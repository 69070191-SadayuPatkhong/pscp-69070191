...
output : เป็นตัวกระจายของที่หารด้วย 10 ลงตัวของ จำนวนนั้น
constraints : input เป็นจำนวนเต็มบวกและ output มีแค่บรรทัดเดียว
...
Step 2: คำนวณหาจำนวนรอบการทำงานโดยการหารเอาส่วน
Step 3: กำหนดค่าเริ่มต้นให้กับตัวแปร ข้อความ "0"
Step 4: วนลูป โดยจำนวนที่หารเอาส่วน
Step 5: นำค่ามาต่อไว้ ด้านหน้า ของข้อความเดิม โดยแทรกช่องว่างไว้ตรงกลาง
Step 6: พิมพ์ ข้อความที่ ต่อเสร็ดแล้ว
```
...
```text
เหมือนเดิม เพราะ ส่งแล้วผ่านและ ได้คิดในส่วนของ 0 ไว้แล้วด้วย
```
...
```text
0 เพื่อเช็คว่าถ้าหารอะไรไม่ได้เลยจะตอบอะไร
```
