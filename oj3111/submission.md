...
```text
นำค่ารวมของ รายการของ มาลดหากเป็น member หรือ ซื้อมากกว่า 500 บาท
input:
...
Constraints:
output เป็น ทศนิยม 2 ตําแหน่ง และใช้ ปัดเศษมาตรฐาน
```
...
```text
Step 1: รับค่า member จำนวน ของที่ซื้อ
Step 2: รับราคา ด้วยจำนวนที่ซื้อแล้วรวมกัน
Step 3: หักส่วนลด 5% หากเป็น member หากไม่ใช้หัก 3% เมื่อ ผลรวม มากกว่าหรือเท่ากับ 500
Step 4: พิมพ์ค่าที่คำนวนแล้วและ round half up แล้ว
```
...
```text
หากเป็น member แต่ผลรวมเกิน 500 ละ
```
...
```text
หากไม่เป็น member และ รวมแล้วไม่ถึง 500 ละ
```
...
```text
หากไม่เป็นmember แต่รวมได้เกินหรือเท่ากับ 500
```
