...
```text
Input: รับค่า เงินที่จ่าย

Output: ควรออกมาเป็รค่าที่ รวมค่าบริการและ  vat แล้ว

Constraints: ค่าบริการอยู่ในระหว่าง 50 - 1000 บาทเท่านั้น
```
...
```text
1: อ่านค่าอาหาร
2: เช็คว่ามากกว่า 0 หากน้อยกว่าให้ พิมพ์ "0.00"
3: หากมากกว่า ให้นำไปคิดค่าบริการ 10% และมีค่าอยู่ระหว่าง 50 - 1000 บาท
4: นำค่าที่คิดได้มาคิดเป็น vat 7% ของค่า บริการ + ค่าที่ต้องจ่าย
5: นำมารวมกันแล้วทำให้มีทศนิยม 2 ตัวแล้ว พิมพ์ค่าที่รวม ค่าที่ต้องจ่าย + vat + ค่าบริการ
```
...
```text
เหมือนเดิม โดยยังคงใช้โครงสร้างเงื่อนไขตรวจค่าอาหารว่ามากกว่า 0 หรือไม่ จากนั้นคำนวณค่าบริการโดยใช้ฟังก์ชัน max(min(...)) เพื่อจำกัดช่วง 50 ถึง 1,000 บาท และคิด VAT 7% ตามเดิม แต่มีการเปลี่ยนจาก round เป็น f"{0:.2f}"เพื่อทศนิยมที่แม่นขึ้น
```
...
```text
เพราะ 0 แปลว่าเราไม่ได้ซื้ออะไรที
```
...
```text
200 บาททำให้ ค่าบริการมีค่า 10% 20 แต่ต้องเป็นอย่างต่ำ 50
```
