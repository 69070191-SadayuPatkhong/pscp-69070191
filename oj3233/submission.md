...
Input:
รับ text 2 บรรทัด
บรรทัดแรกที่ ฉลากที่ถูก
และบรรทัดที่ ที่เอามาเทียบ

Output:
พิมพ์จำนวนเงินรางวัลที่กระต่ายน้อยได้รับ โดยเลือกรางวัลที่มีมูลค่าสูงสุดเพียงรางวัลเดียว 

Constraints:
ตัวอักษรมี 1 ตัวอักษร และหมายเลขสลากมี 5 หลักเสมอ
```
...
```text
Step 1: อ่านข้อมูล เลขที่ออกรางวัล และ เลขที่ซื้อ
Step 2: ตรวจว่าตัวอักษรตรงกัน และเลข 5 หลักตรงกันหรือไม่
Step 3: ตรวจว่าเลข 5 หลักตรงกันหรือไม่
Step 4: ตรวจว่าตัวอักษรตรงกัน และเลขท้าย 3 ตัวตรงกันหรือไม่
Step 5: ตรวจว่าตัวอักษรตรงกัน และเลขท้าย 2 ตัวตรงกันหรือไม่
Step 6: ตรวจว่าเลขท้าย 3 ตัวตรงกันหรือไม่
Step 7: ตรวจว่าเลขท้าย 2 ตัวตรงกันหรือไม่
Step 8: ตรวจว่าตัวอักษรตรงกันหรือไม่
Step 9: พิมพ์เงินรางวัลตามเงื่อนไขแรกที่เป็นจริง
```
...
```text
แผนเดิมเพราะ ผ่านแล้ว ใช้ if statement เทียบไปเลย
...
```text
ตัวอักษรตรงเลขท้าย 2 ตัวตรงแต่เลขท้าย 3 ตัวไม่ตรง
```
