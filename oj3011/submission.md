...
```text
Input : รับค่าสี 2 สี
Output : หากไม่ใช่แม่สีให้ Error แต่ถ้าเป็นแม่สีให้ผสมสี หากเป็นสีเดียวกันทั้งสองให้ออกมาเป็นสีเดิม
Constraints : พิจารณา ว่า input ทั้ง 2 อยู่ในแม่สีรึป่าส
```
...
```text
Step 1: อ่านค่าสี
Step 2: ถ้า ไม่ใช่แม่สี ให้พิมพ์ "Error"
Step 3: ถ้า สีเหมือนกัน ให้พิมพ์สีนั้นออกไปเลย
Step 4: ถ้าไม่ใช่ทั้งสองข้อ ให้จับคู่ผสมสีตามเงื่อนไขใน lookup array
```
...
```text
เหมือนกัน ใช้ array ในการ look up สีทำให้สามารถปรับเปลี่ยนได้ง่าย
```
