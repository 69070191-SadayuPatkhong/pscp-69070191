...
```text
Input : รับตัวอักษรแล้วเปลียนเป็น lowercase
Output : กลับตัวอักษรให้กลับด้าน (reverse)
Constraints : input เป็นตัวอักษร
```
...
```text
2452 เพราะหน้าหลังเหมือนกันและเป็นตัวแรก
```
...
```text
เช็คว่าเปลี่ยนเป็น lowercase รึป่าว
```
