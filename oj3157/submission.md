...
```text
input: รับจำนวน n เพื่อใช้ loop รับ n จำนวน เป็น + และ -

output: ค่ารวมที่คิดจากการ บวกและลบแล้ว
...
Step 2: loop รับค่าจำนวน n ตัว
Step 3: หากค่าที่ได้เป็น + ให้เพิ่มค่าที่จะ output 10 หากเป็น - ให้ลบ 5
Step 4: พิมพ์ output ที่บวกลบแล้ว
```
