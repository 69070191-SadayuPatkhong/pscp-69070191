...
```text
หาจํานวนนับ x ในช่วง [A , B] กี่จํานวน ที่หารด้วยจํานวนนับ d แล้วเหลือเศษ r
input : 
...
output : 
จำนวนนับที่หารด้วย d แล้วเหลือเศษ r
```
...
```text
Step 1: รับค่าตัวแปร ตาม Input Specification
Input Specification
บรรทัดที่ 1 จํานวนนับ A :
บรรทัดที่ 2 จํานวนนับ B : (โดยที่ B > A)
บรรทัดที่ 3 จํานวนนับ d (ตัวหาร) :
บรรทัดที่ 4 จํานวนนับ r (เศษ) : (โดยที่ r < d)
Step 2: คำนวณว่า A-B มีกี่จำนวนที่ตรงเงื่อนไข
Step 3: พิมพ์จำนวนที่เข้าเงื่อไข
```
...
```text
แผนเดิมเพราะทดลองแล้วผ่านและตรงตามโจทย์
```
...
```text
หาร 1 ลงตัวแล้วไม่เหลือเศษ มันก็ต้องทุกตัว
```
...
```text
ไม่มีตัวไหนหารแล้วเหลื่อเศษตรงที่ต้องการ
```
