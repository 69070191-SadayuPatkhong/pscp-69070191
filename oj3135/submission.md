...
```text
input:
จำนวนเต็ทบวก 3 จำนวน 
ตัวแรกคือ จำนวนคนทั้งหมด
ตัวที่สองคือ คนที่ตรวจคนต่อไปที่จะตรวจ บวกคนที่จะตรวจปัจุบัน
ตัวที่สามคือ โจรที่ได้แล้วจบ loop ทันที

output: 
จำนวนคนที่ได้ตรวจ

constraints:
input เป็นบรรทันเดียวแต่มีหลายตัวแปรต้องใช้ split
```
...
```text
Step 1: อ่านค่าจำนวนเต็ม n k t
Step 2: ให้วนจนว่า คนตรวจปัจุบัน จะเป็นโจร หรือวนกลับมาคนที่ 1 แล้วเช็กว่าคนที่ได้รับคนต่อไปเป็นโจรรึป่าว คนที่รับคนต่อไปคือ คนปัจจุบัล + k 
Step 3: พิมพ์ คนที่ตวรจทั้งหมด
```
...
```text
วิธีเดิมแค่ ตอนแรก เผอ hardcode เลข 4 ไปเลยต้องแก้
```
