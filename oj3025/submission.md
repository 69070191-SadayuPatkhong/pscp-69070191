...
```text
input : เดือน และ วันที่เท่าไหรของเดือน
output : ฤดูต่างๆ ตามปกติ แต่ถ้าเดือนหาร 3 ลงตัว หรือ เป็นวันตั่งแต่ 21 ขึ้นไป จะออกเป็น ฤดูที่แปลกไป
constraints : เดื่อน 1 - 12 วัน 1 - 31 เท่านั้น
```
...
```text
Step 1: อ่านค่าเดือนและวัน
Step 2: เช็คเดือนก่อนแล้วเปลียนตัวแปรฤดูตามที่ให้มา
Step 3: เช็คว่า เดือนหาร 3 ลงตัว หรือเป็นวันที่ >= 21 ให้เปลี่ยนฤดูใหม่อีกรอบ
Step 4: พิมพ์ตัวแปรฤดู 
```
...
```text
เหมือนแผลแรก เพราะข้อนี้เช็คง่ายๆ ไม่ได้มี edge case อะไรเยอะ
...
```text
เป็นการเช็คว่า ผ่าน condition 3 หารลงตัว
```
...
```text
เป็นการเช็คว่า ผ่าน condition วันมากกว่าหรือเท่ากับ 21
```
